...
import com.teoking.common.GenericListAdapter
import com.teoking.common.decodeExifOrientation
...
class ImageViewerFragment(private val args: ImageViewerFragmentArgs) : Fragment() {
    ...
    companion object {
        ...
        data class ImageViewerFragmentArgs(val filePath: String, val depth: Boolean, val orientation: Int)
